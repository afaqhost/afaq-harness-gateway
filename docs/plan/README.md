...
| 02 | [phase-02-cancel-process-lifecycle.md](phase-02-cancel-process-lifecycle.md) | Cancel & Process Lifecycle | 3h | S1 | ⬜ Next |
...
*S1 done. Next: `phase-02-cancel-process-lifecycle.md:4.1`.*
